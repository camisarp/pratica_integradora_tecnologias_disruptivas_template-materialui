...
const initialRows = [
  createData(1, 'PR3', 'Atividade Faculdade', '2024-06-02', '2024-06-02', 'Concluída', 'Recurso 1'),
  createData(2, 'PR4', 'Atividade Faculdade', '2024-06-02', '2024-06-02', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Treino corrida', 'Treinar para corrida das Pontes', '2024-04-02', '2024-06-02', 'Em Andamento', 'Recurso 3'),
];
